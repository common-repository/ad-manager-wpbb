...
Donate link: http://www.letsfx.com/adsmanager  
...
= : 1.6.8 =
*Do not display Float-ad if the user is visiting using a mobile device.

= : 1.6.7 =
*Never display Float-ad if user click [close].

= : 1.6.6 =
*Now handle [shortcodes] in place of ad code.

= : 1.6.5 =
*Add option to hide Ads for posts contains "&lt;!--NOADD--&gt;"
